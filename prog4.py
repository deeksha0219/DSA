...
class LinkedList:
    ...
    def delete_node(self, data):
        current = self.head
        if current and current.data == data:  # Case where node to delete is the head
            self.head = current.next
            current = None
            return

        prev = None
        while current and current.data != data:  # Search for the node to delete
            prev = current
    ...
    def traverse(self):
        ...
        while current:
            ...
            current = current.next
        print()  # For newline after traversing the list
